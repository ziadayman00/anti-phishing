...
export default function VishingSimulation() {
    ...
    const simulationData = [
        {
            call: "Hello, this is tech support. We detected a virus. Please provide your password.",
            isPhishing: true,
            explanation: "Legitimate tech support never asks for passwords over the phone."
        },
        {
            call: "This is your bank. Confirm your PIN to secure your account.",
            isPhishing: true,
            explanation: "Banks don’t ask for sensitive info like PINs via unsolicited calls."
        },
        {
            call: "Hi, this is your ISP. We’re upgrading your plan. No action needed.",
            isPhishing: false,
            explanation: "No urgent request or sensitive info asked, likely safe."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            <Head title="Voice Phishing Simulation - AntiPhishing" />
            <Navbar />
                ...
                >
                    <div className="bg-gray-800/90 backdrop-blur-md shadow-2xl rounded-2xl border border-cyan-500/30 p-8">
                        ...
                        <div className="flex items-center space-x-6 mb-8">
                            ...
                            <div>
                                <h1 className="text-4xl font-extrabold text-white tracking-tight">Voice Phishing Simulation</h1>
                                <p className="mt-2 text-lg text-cyan-200 font-mono">Step {step} of {totalSteps} | Score: {score}</p>
                            </div>
                        </div>

                        <p className="mb-6 text-lg text-gray-300">Analyze the call below. Is it safe or a phishing attempt?</p>

                        <div className="p-6 bg-gray-700/50 rounded-xl border border-cyan-500/20 mb-8">
                            <p className="mt-4 text-gray-200 whitespace-pre-line">{simulationData[step - 1].call}</p>
                        </div>
