...
export default function WebsiteSimulation() {
    ...
    const simulationData = [
        {
            ...
            body: "Please enter your email and password to continue.",
            isPhishing: true,
            explanation: "The URL uses 'g00gle' instead of 'google', a common phishing trick."
        },
        {
            url: "https://www.paypal.com/login",
            body: "Log in to your PayPal account.",
            isPhishing: false,
            explanation: "This is the official PayPal domain with no red flags."
        },
        {
            url: "http://amazon-security.net",
            body: "Update your payment details now!",
            isPhishing: true,
            explanation: "Uses 'http' instead of 'https' and a fake domain."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            <Head title="Website Phishing Simulation - AntiPhishing" />
            <Navbar />
                ...
                >
                    <div className="bg-gray-800/90 backdrop-blur-md shadow-2xl rounded-2xl border border-cyan-500/30 p-8">
                        ...
                        <div className="flex items-center space-x-6 mb-8">
                            ...
                            <div>
                                <h1 className="text-4xl font-extrabold text-white tracking-tight">Website Phishing Simulation</h1>
                                <p className="mt-2 text-lg text-cyan-200 font-mono">Step {step} of {totalSteps} | Score: {score}</p>
                            </div>
                        </div>

                        <p className="mb-6 text-lg text-gray-300">Analyze the website below. Is it safe or a phishing attempt?</p>

                        <div className="p-6 bg-gray-700/50 rounded-xl border border-cyan-500/20 mb-8">
                            <p className="text-sm text-cyan-400 font-mono">URL: {simulationData[step - 1].url}</p>
