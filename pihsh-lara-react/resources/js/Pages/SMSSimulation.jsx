...
export default function SMSSimulation() {
    ...
    const totalSteps = 3; // عدد السيناريوهات

    const simulationData = [
        {
            sender: "+1-555-123-4567",
            body: "Your package is delayed. Track it here: bit.ly/xyz123",
            isPhishing: true,
            explanation: "Shortened URLs like 'bit.ly' are often used to hide malicious links."
        },
        {
            sender: "YourBank",
            body: "Account alert: Verify your identity at bank-login.com now!",
            isPhishing: true,
            explanation: "Legit banks don’t use generic domains like 'bank-login.com'."
        },
        {
            sender: "+1-800-555-0101",
            body: "Your subscription is renewed. Details: support.netflix.com",
            isPhishing: false,
            explanation: "This matches Netflix’s official domain and lacks urgency."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            <Head title="SMS Phishing Simulation - AntiPhishing" />
            <Navbar />
                ...
                >
                    <div className="bg-gray-800/90 backdrop-blur-md shadow-2xl rounded-2xl border border-cyan-500/30 p-8">
                        ...
                        <div className="flex items-center space-x-6 mb-8">
                            ...
                            <div>
                                <h1 className="text-4xl font-extrabold text-white tracking-tight">SMS Phishing Simulation</h1>
                                <p className="mt-2 text-lg text-cyan-200 font-mono">Step {step} of {totalSteps} | Score: {score}</p>
                            </div>
                        </div>

                        <p className="mb-6 text-lg text-gray-300">Analyze the SMS below. Is it safe or a phishing attempt?</p>

                        <div className="p-6 bg-gray-700/50 rounded-xl border border-cyan-500/20 mb-8">
                            <p className="text-sm text-cyan-400 font-mono">From: {simulationData[step - 1].sender}</p>
                            <p className="mt-4 text-gray-200 whitespace-pre-line">{simulationData[step - 1].body}</p>
                        </div>
