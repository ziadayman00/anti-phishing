...
export default function MultiChannelSimulation() {
    ...
    const simulationData = [
        {
            email: "Your account is compromised. Click here to secure it.",
            sms: "Urgent: Verify your account at bit.ly/xyz123.",
            call: "This is your bank. Provide your PIN to confirm.",
            isPhishing: true,
            explanation: "Multiple urgent requests across channels with suspicious links and demands are phishing signs."
        },
        {
            email: "Your subscription is renewed. Details at netflix.com.",
            sms: "Thanks for renewing! No action needed.",
            call: "This is Netflix support confirming your renewal.",
            isPhishing: false,
            explanation: "Consistent messaging with official domains and no urgent demands."
        },
        {
            email: "Update your payment at amazon-security.net.",
            sms: "Payment failed. Visit amazon-security.net now!",
            call: "This is Amazon. Provide your card details to resolve.",
            isPhishing: true,
            explanation: "Fake domain and unsolicited payment requests across channels."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            <Head title="Multi-Channel Phishing Simulation - AntiPhishing" />
            <Navbar />
                ...
                >
                    <div className="bg-gray-800/90 backdrop-blur-md shadow-2xl rounded-2xl border border-cyan-500/30 p-8">
                        ...
                        <div className="flex items-center space-x-6 mb-8">
                            ...
                            <div>
                                <h1 className="text-4xl font-extrabold text-white tracking-tight">Multi-Channel Phishing Simulation</h1>
                                <p className="mt-2 text-lg text-cyan-200 font-mono">Step {step} of {totalSteps} | Score: {score}</p>
                            </div>
                        </div>

                        <p className="mb-6 text-lg text-gray-300">Analyze the multi-channel attack below. Is it safe or a phishing attempt?</p>

                        <div className="p-6 bg-gray-700/50 rounded-xl border border-cyan-500/20 mb-8">
                            <p className="text-sm text-cyan-400 font-mono">Email: {simulationData[step - 1].email}</p>
                            <p className="mt-2 text-sm text-cyan-400 font-mono">SMS: {simulationData[step - 1].sms}</p>
                            <p className="mt-2 text-sm text-cyan-400 font-mono">Call: {simulationData[step - 1].call}</p>
                        </div>
